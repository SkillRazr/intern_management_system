          ...
          <form id="intern-form" className="flex flex-col justify-center" onSubmit={internForm}>
            ...
            <div className="two-labels-container flex">
              <label htmlFor='name' className="intern-form-label">
                <p>Name</p>
                <input type='text' name='name' id='name' className="intern-form-input" required onChange={(e) => {setName(e.target.value)}}/>
              </label>
              <label htmlFor='phoneNo' className="intern-form-label ml-2">
                <p>Phone number</p>
                <input type='tel' name='phoneNo' id='phoneNo' pattern="^\+\d{2}\s\d{10}$" className="intern-form-input" placeholder="+91 1234567890" required onChange={(e) => {setMobileNo(e.target.value)}}/>
              </label>
            ...
            <label htmlFor='email' className="intern-form-label"> 
              <p>Email</p>
              <input type='email' name='email' id='email' pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" className="intern-form-input" required onChange={(e) => {setEmail(e.target.value)}}/>
            </label>

            <label htmlFor='github' className="intern-form-label"> 
              <p>GitHub URL</p>
              <input type='url' name='github' id='github' pattern="^https:\/\/github\.com\/.+$" className="intern-form-input" onChange={(e) => {setGithub(e.target.value)}}/>
            </label>

            <div className="two-labels-container flex">
              <label htmlFor='join' className="intern-form-label">
                <p>Joined date</p>
                <input type='date' name='join' id='join' className="intern-form-input" required onChange={(e) => {setJoinDate(e.target.value)}}/>
              </label>
              <label htmlFor='end' className="intern-form-label ml-2">
                <p>End date</p>
                <input type='date' name='end' id='end' className="intern-form-input" onChange={(e) => {setEndDate(e.target.value)}}/>
              </label>
            </div>

            <label htmlFor='notes' className="intern-form-label">
              <p>Notes</p>
              <textarea type='text' name='notes' id='notes' className="intern-form-input max-h-24" onChange={(e) => {setNotes(e.target.value)}}/>
            </label>
