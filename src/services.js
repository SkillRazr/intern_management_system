...
export const addIntern = async (payload) => {
  ...
  return await fetch(
    `http://127.0.0.1:5001/skillrazr-mobile/asia-south1/api/addIntern`,
    {
      headers: {
        "Content-Type": "application/json",
        "skillrazr-sub-app":  "interns!1234#@234_hello",
...
export const saveNote = async (payload) => {
  return await fetch(
    "http://127.0.0.1:5001/skillrazr-mobile/asia-south1/api/updateInternNotes",
    {
      headers: {
        "Content-Type": "application/json",
        "skillrazr-sub-app":  "interns!1234#@234_hello",
...
export const updateAttendance = async (payload) => {
  return await fetch(
    "http://127.0.0.1:5001/skillrazr-mobile/asia-south1/api/updateInternsAttendance",
    {
      headers: {
        "Content-Type": "application/json",
        "skillrazr-sub-app":  "interns!1234#@234_hello",
